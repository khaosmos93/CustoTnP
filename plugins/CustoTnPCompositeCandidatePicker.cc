...
class CustoTnPCompositeCandidatePicker : public edm::EDProducer {
public:
  explicit CustoTnPCompositeCandidatePicker(const edm::ParameterSet&);
...
CustoTnPCompositeCandidatePicker::CustoTnPCompositeCandidatePicker(const edm::ParameterSet& cfg)
...
void CustoTnPCompositeCandidatePicker::remove_overlap(pat::CompositeCandidateCollection& cands) const {
...
std::vector<reco::TransientTrack> CustoTnPCompositeCandidatePicker::get_transient_tracks(const pat::CompositeCandidate& dil) const {
...
std::pair<bool, float> CustoTnPCompositeCandidatePicker::back_to_back_cos_angle(const pat::CompositeCandidate& dil) const {
...
std::pair<bool, CachingVertex<5> > CustoTnPCompositeCandidatePicker::vertex_constrained_fit(const pat::CompositeCandidate& dil) const {
...
void CustoTnPCompositeCandidatePicker::embed_vertex_constrained_fit(pat::CompositeCandidate& dil, const CachingVertex<5>& vtx) const {
  if (!vtx.isValid()) {
...
std::pair<bool, float> CustoTnPCompositeCandidatePicker::dpt_over_pt(const pat::CompositeCandidate& dil) const {
...
void CustoTnPCompositeCandidatePicker::produce(edm::Event& event, const edm::EventSetup& setup) {
...
DEFINE_FWK_MODULE(CustoTnPCompositeCandidatePicker);
